...
(function (g) {
  ...
  }) : "object" === (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = function (q, r) {
    q || (q = window);
  ...
  m.Client.prototype = {
    ...
    getHTML: function getHTML(a, b) {
      ...
      if (navigator.userAgent.match(/MSIE/)) {
        ...
        c += '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="' + f + 'download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=10,0,0,0" width="' + a + '" height="' + b + '" id="' + this.movieId + '" align="middle"><param name="allowScriptAccess" value="always" /><param name="allowFullScreen" value="false" /><param name="movie" value="' + m.moviePath + '" /><param name="loop" value="false" /><param name="menu" value="false" /><param name="quality" value="best" /><param name="bgcolor" value="#ffffff" /><param name="flashvars" value="' + d + '"/><param name="wmode" value="transparent"/></object>';
    ...
    receiveEvent: function receiveEvent(a, b) {
      ...
      if (this.handlers[a]) for (var d = 0, f = this.handlers[a].length; d < f; d++) {
        ...
        if ("function" == typeof e) e(this, b);else if ("object" == _typeof(e) && 2 == e.length) e[0][e[1]](this, b);else if ("string" == typeof e) q[e](this, b);
      }
    }
  };
  ...
  var O = function O(a, b) {
    ...
    var d = b.fieldBoundary,
      ...
      for (var x = "", B = 0, h = u.length; B < h; B++) {
        0 < B && (x += f), x += d ? d + ("" + u[B]).replace(e, n + d) + d : u[B];
      }
  ...
  w.ext.buttons.excelFlash = g.extend({}, I, {
    ...
    action: function action(a, b, c, d) {
      ...
      for (var x = 0, B = k.body.length; x < B; x++) {
        p(k.body[x], f);
      }
