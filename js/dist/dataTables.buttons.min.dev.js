...
(function (e) {
  ...
  }) : "object" === (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = function (A, z) {
    A || (A = window);
  ...
  e.extend(w.prototype, {
      ...
      if (!b._buttonsHandled) {
        var c = function c(d) {
          for (var h = 0, f = d.length; h < f; h++) {
            var k = d[h].conf,
                g = d[h].node;
            k.key && (k.key === a ? (b._buttonsHandled = !0, e(g).click()) : !e.isPlainObject(k.key) || k.key.key !== a || k.key.shiftKey && !b.shiftKey || k.key.altKey && !b.altKey || k.key.ctrlKey && !b.ctrlKey || k.key.metaKey && !b.metaKey || (b._buttonsHandled = !0, e(g).click()));
    ...
    _popover: function _popover(a, b, c) {
      ...
      if ("absolute" === g && (c.hasClass(h.rightAlignClassName) || c.hasClass(h.leftAlignClassName) || "dt-container" === h.align)) {
        ...
        top: m.top + f.outerHeight(),
        left: m.left
      }), l = c.outerHeight(), g = f.offset().top, r = 0, r = f.offset().left, B = f.outerWidth(), B = r + B, g = c.offset().left, q = a.width(), q = g + q, y = m.top - l - 5, n = d.offset().top + d.height(), p = m.top + f.outerHeight() + l, n = p - n, p = m.top - l, v = d.offset().top, (n > v - p || h.dropup) && -y < v && c.css("top", y), r = "button-right" === h.align ? B - q : r - g, c.css("left", c.position().left + r)) : (g = c.height() / 2, g > e(A).height() / 2 && (g = e(A).height() / 2), c.css("marginTop", -1 * g));
  ...
  w.instanceSelector = function (a, b) {
    ...
    var c = [],
      ...
      return f.name;
        ...
        h = function h(f) {
      if (Array.isArray(f)) for (var k = 0, g = f.length; k < g; k++) {
        h(f[k]);
  ...
  w.buttonSelector = function (a, b) {
    for (var c = [], d = function d(g, m, l) {
      ...
      if (Array.isArray(g) || g instanceof e) for (p = 0, l = g.length; p < l; p++) {
        h(g[p], m);
      } else if (null === g || g === u || "*" === g) for (p = 0, l = n.length; p < l; p++) {
        c.push({
          inst: m,
          node: n[p].node
        });
        ...
        if (-1 !== g.indexOf(",")) for (n = g.split(","), p = 0, l = n.length; p < l; p++) {
          h(n[p].trim(), m);
        ...
        });else if (-1 !== g.indexOf(":name")) for (g = g.replace(":name", ""), p = 0, l = n.length; p < l; p++) {
          n[p].name === g && c.push({
            inst: m,
            node: n[p].node
          });
      ...
      } else "object" === _typeof(g) && g.nodeName && (n = e.inArray(g, p), -1 !== n && c.push({
        inst: m,
        node: p[n]
      }));
      ...
      return {
        ...
        buttons: e.map(b, function (d, h) {
          return {
            ...
            action: function action(f, k) {
              k.page.len(d).draw();
            },
            init: function init(f, k, g) {
              var m = this;
            ...
            destroy: function destroy(f, k, g) {
              f.off("length.dt" + g.namespace);
            }
          };
        }),
        init: function init(d, h, f) {
          var k = this;
          d.on("length.dt" + f.namespace, function () {
            k.text(f.text);
          });
        },
        destroy: function destroy(d, h, f) {
  ...
  var G = function G(a) {
    ...
    var c = e.extend(!0, {}, {
      ...
      trim: !0,
      format: {
        header: function header(q) {
          return d(q);
        },
        footer: function footer(q) {
          return d(q);
        },
        body: function body(q) {
          return d(q);
        }
      },
      customizeData: null
