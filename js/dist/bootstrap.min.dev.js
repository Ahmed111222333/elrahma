...
!function (t, e) {
  ...
  var ct,
    ...
    return t.toggle = function () {
      ...
      return this.each(function () {
        var t = g(this),
            e = t.data(ut),
            n = l({}, gt, t.data(), "object" == _typeof(i) && i ? i : {});
  ...
  var Dt = "dropdown",
    ...
    return t.toggle = function () {
      ...
      return this.each(function () {
        ...
        if (t || (t = new c(this, "object" == _typeof(e) ? e : null), g(this).data(wt, t)), "string" == typeof e) {
    ...
    return t.toggle = function (t) {
      ...
      return this.each(function () {
        var t = g(this).data(Zt),
            e = l({}, ee, g(this).data(), "object" == _typeof(n) && n ? n : {});
  ...
  var Je = "scrollspy",
    ...
    return t.refresh = function () {
      ...
      if ("string" != typeof (t = l({}, en, "object" == _typeof(t) && t ? t : {})).target) {
      ...
      return this.each(function () {
        ...
        if (t || (t = new n(this, "object" == _typeof(e) && e), g(this).data(Ze, t)), "string" == typeof e) {
          if ("undefined" == typeof t[e]) throw new TypeError('No method named "' + e + '"');
          t[e]();
        }
      });
  ...
  var jn = "toast",
    ...
    return t.show = function () {
      ...
      return t = l({}, Bn, g(this._element).data(), "object" == _typeof(t) && t ? t : {}), _.typeCheckConfig(jn, t, this.constructor.DefaultType), t;
    }, t._setListeners = function () {
      var t = this;
      ...
      return this.each(function () {
        ...
        if (e || (e = new i(this, "object" == _typeof(n) && n), t.data(Rn, e)), "string" == typeof n) {
          if ("undefined" == typeof e[n]) throw new TypeError('No method named "' + n + '"');
          e[n](this);
        }
      });
